// No 'use client' needed if we are just exporting a plain object
...
// Define the components map directly
export const mdxComponents: MDXComponents = {
  // Start of the component mapping object
    // Custom components
    Alert,
    ImageWithCaption,
    Callout,
...
// No need for the useMDXComponents function or default export anymore